  ...
  --require(don_recipes_prototypes_path .. "new-available-from-start"),

  -- -- Recipes for buildings and other entities (not associated non-buildings-items)
  --require(don_recipes_prototypes_path .. "buildings"),

  -- -- New generic recipes for items (not associated to buildings)
  --require(don_recipes_prototypes_path .. "items-crafting"),
